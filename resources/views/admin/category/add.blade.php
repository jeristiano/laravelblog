    ...
    <form action="{{url('admin/category')}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                <th>分类标题：</th>
                <td>
                    <input type='text' name="cate_title" value="{{old('cate_title')}}">
                </td>
            </tr>
            <tr>
                <th>关键词：</th>
                <td>
                    <input  type="text" name="cate_keywords" value="{{old('cate_keywords')}}">
            </tr>
            ...
            <tr>
                <th>描述：</th>
                <td>
                    <textarea class="lg" name="cate_description" value="{{old('cate_description')}}"></textarea>
                </td>
            </tr>
            <tr>
                <th></th>
