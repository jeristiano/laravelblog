    ...
    <div class="row" style="border-bottom-right-radius: 4px;border: 1px solid gainsboro">
        <form class="form-horizontal " role="form" method="post" >
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control w300" placeholder="请输入名字" name="Student[name]"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control w300" id="lastname" name="Student[age]" placeholder="请输入年龄"
                           value={{ old('Student')['name']? old('Student')['age']:$student->age}}>
                </div>
                ...
                <div class="col-sm-5">
                    @foreach($sex as $k=>$v)
                        <label class="checkbox-inline">
                            <input type="radio" id="inlineCheckbox1" name="Student[sex]" @if($k==$student->sex)
